...
const CardsCharacter = ({ character }) => {
  ...
  const handleClick = () => {
    const screenMovil = window.innerWidth;
    setId(id);
    if (!(screenMovil > 1023)) {
      pushLocation(`/personaje/${id}`);
    }
  };

  return (
    <button type='button' className='my-4 mx-auto' onClick={handleClick}>
